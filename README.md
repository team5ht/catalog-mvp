...
- `styles/tokens.css` — единственный канонический источник дизайн‑токенов (CSS variables).
- `styles/ui.css` — UI‑kit: базовая типографика/контейнеры, компоненты, навигация, карточки, карусели.
- `styles/pages.css` — минимальные page‑specific раскладки и исключения.
...
- `styles/README.md` — актуальная структура стилей и порядок подключения.
...
- `styles/tokens.css` — единственный источник токенов (палитра, типографика, тени, отступы, layout‑переменные).
- `styles/ui.css` — UI‑kit: базовая типографика/контейнеры, компоненты, навигация, карточки, карусели.
