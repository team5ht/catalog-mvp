...
- `nav-auth.js` / `material.html` - используют Supabase: проверяют сессию, подписываются на `onAuthStateChange`, переключают UI и делают `signOut()`.
